...
export default function IdSearchComponent () {
    ...
    const onClickIdSearch=(e)=>{
        ...
        if( state.name==='' ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/pororo/pororo_id_search_name_email.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickIdSearch2=(e)=>{
        ...
        if( state.name==='' ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/pororo/pororo_id_search_name_hp.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
                        ...
                        state.isHpSearch && (
                            <form>
                                <ul>
                                    ...
                                    <li>
                                        <label htmlFor="userEmail">휴대폰번호</label>
                                        <input 
                                            type="text" 
                                            name='userHp' 
                                            id='userHp'  
