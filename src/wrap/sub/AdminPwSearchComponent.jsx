...
export default function AdminPwSearchComponent () {
    ...
    const onClickIdSearch=(e)=>{
        ...
        if( state.id==='' ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/pororo/pororo_admin_pw_search.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
                if( res.status===200 ) {
                    navigate('/adminpwsearchResult', {
                        state: {
                            pw: res.data.비밀번호
                        }
                    });
            ...
            <div className="container">
                ...
                <div className="content">
                    <form>
                        <ul>
                            <li>
                                <label htmlFor="adminName">관리자 아이디</label>
                                <input 
                                    type="text" 
                                    name='adminId' 
                                    id='adminId' 
