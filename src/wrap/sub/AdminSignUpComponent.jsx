...
export default function AdminSignUpComponent() {
    ...
    const onClickDuplicationId=(e)=>{
        ...
        if( value.length > 12 || regexp1.test(value)===false || regexp2.test(value)===true ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/pororo/pororo_admin_id_duplication.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
    ...
    const onClickDuplicationEmail=(e)=>{
        ...
        if( value==='' ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/pororo/pororo_admin_email_duplication.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
    ...
    const onClickSignUp=(e)=>{
        ...
        if( state.id===''){
            ...
            dispatch(adminSignUpModal(true));
            okModalMethod('관리자 회원가입을 하시겠습니까?');
                ...
                <form >
                        ...
                        <li>
                            ...
                            <div className='right'>
                                <input 
                                    ...
                                    className='check'
                                />
                                <label htmlFor="checkbox">관리자</label>
                            </div>
                        </li>
                    </ul>
                    <div className="form_box">
                        ...
                        <div className="button_box">
                            <button onClick={onClickSignUp}>관리자 회원가입</button>
                        </div>
                    </div>
                </form>
            </div>
